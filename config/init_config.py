...
with open(local.project_path.joinpath('config', 'registry.py'), 'w') as file:
    ...
    parent_bvd9_full_path = os.fspath(case_path.joinpath('parents - ' + config.get('DEFAULT', 'out_bvd9_full') + '.csv'))
    parent_bvd9_short_path = os.fspath(case_path.joinpath('parents - ' + config.get('DEFAULT', 'out_bvd9_short') + '.csv'))
    parent_bvd9_collect_path = os.fspath(case_path.joinpath('parents - collect - ' + config.get('DEFAULT', 'out_bvd9_full') + '.csv'))
    ...
    sub_bvd9_short_path = os.fspath(case_path.joinpath('subsidiaries - ' + config.get('DEFAULT', 'out_bvd9_short') + '.csv'))
    sub_bvd9_collect_path = os.fspath(case_path.joinpath('subsidiaries - collect - ' + config.get('DEFAULT', 'out_bvd9_full') + '.csv'))
