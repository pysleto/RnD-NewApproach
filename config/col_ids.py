...
group_structure_ids = ['unique_id',
                       'guo_bvd9', 'guo_name', 'guo_conso', 'guo_country_2DID_iso',
                       'bvd9', 'company_name', 'parent_conso', 'country_2DID_iso',
                       'sub_bvd9', 'sub_company_name', 'sub_conso', 'sub_country_2DID_iso']
...
dtype = {
    col: str for col in [
        'guo_bvd9', 'guo_bvd_id', 'guo_legal_entity_id', 'guo_conso', 'guo_NACE_4Dcode',
        'parent_bvd9', 'parent_bvd_id', 'parent_legal_entity_id', 'parent_conso', 'parent_NACE_4Dcode',
