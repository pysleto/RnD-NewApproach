...
# ref_country = pd.read_csv(reg.ref_country, error_bad_lines=False, encoding='UTF-8')
ref_country = pd.read_csv(r'C:\Users\Simon\PycharmProjects\rnd-private\ref_tables\country_table.csv')
